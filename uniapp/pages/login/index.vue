<template>
	<view v-if="configInfo.small_switch ==0" style="position: fixed;top: 0;bottom: 0;right:0;left: 0;background-size: 100% 100%;">
		
		<image class="login-logo" :style="{'margin-top':navHeight}" src="../../static/images/wanyue.png" mode=""></image>
		<!-- <image v-if="configInfo.small_switch == 0" class="login-logo-text" src="../../static/images/jieshao.png"></image> -->
